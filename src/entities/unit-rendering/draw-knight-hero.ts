...
export function drawKnight(unit: Unit, ctx: CanvasRenderingContext2D, age: number, bob: number, moving: boolean, isInAttackRange: boolean = false): void {
    ...
    switch (civ) {
        ...
        case CivilizationType.LaMa:
            ...
            horseBlankColor = cv.bodyMid; horseTrimColor = '#daa520';
            break;
    ...
    switch (civ) {
        ...
        case CivilizationType.LaMa:
            ...
            if (age >= 3) {
                ctx.fillStyle = cv.bodyMid; // Team-colored cloth
    ...
    switch (civ) {
        ...
        case CivilizationType.LaMa:
            ...
            ctx.fillStyle = age >= 4 ? cv.bodyLight : cv.bodyMid;
